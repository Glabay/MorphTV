...
*/
        ...
        r12 = r12.lock;
        monitor-enter(r12);
        r0 = r11.zzfa;	 Catch:{ all -> 0x0057 }
        r0 = r0.zzev;	 Catch:{ all -> 0x0057 }
        r1 = r11.zzfb;	 Catch:{ all -> 0x0057 }
        r0.zza(r1);	 Catch:{ all -> 0x0057 }
        r0 = 0;
        r1 = r11.zzfa;	 Catch:{ IllegalStateException -> 0x0034, IllegalStateException -> 0x0034 }
        r2 = r1.zzeu;	 Catch:{ IllegalStateException -> 0x0034, IllegalStateException -> 0x0034 }
        r3 = r11.zzgc;	 Catch:{ IllegalStateException -> 0x0034, IllegalStateException -> 0x0034 }
        r4 = r11.zzfj;	 Catch:{ IllegalStateException -> 0x0034, IllegalStateException -> 0x0034 }
        r5 = r11.zzfk;	 Catch:{ IllegalStateException -> 0x0034, IllegalStateException -> 0x0034 }
        ...
        r10 = r11.zzfi;	 Catch:{ IllegalStateException -> 0x0034, IllegalStateException -> 0x0034 }
        r2.zza(r3, r4, r5, r6, r7, r8, r10);	 Catch:{ IllegalStateException -> 0x0034, IllegalStateException -> 0x0034 }
        r1 = r11.zzfa;	 Catch:{ all -> 0x0057 }
