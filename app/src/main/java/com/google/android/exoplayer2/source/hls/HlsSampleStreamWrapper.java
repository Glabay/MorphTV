...
final class HlsSampleStreamWrapper implements com.google.android.exoplayer2.upstream.Loader.Callback<Chunk>, ReleaseCallback, SequenceableLoader, ExtractorOutput, UpstreamFormatChangedListener {
    ...
    private final Runnable maybeFinishPrepareRunnable = new C07451();
    ...
    private final Runnable onTracksEndedRunnable = new C07462();
    ...
    /* renamed from: com.google.android.exoplayer2.source.hls.HlsSampleStreamWrapper$1 */
    ...
    /* renamed from: com.google.android.exoplayer2.source.hls.HlsSampleStreamWrapper$2 */
    ...
    public boolean selectTracks(TrackSelection[] trackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j, boolean z) {
        ...
        while (i3 < trackSelectionArr2.length) {
            if (sampleStreamArr2[i3] != null && (trackSelectionArr2[i3] == null || !zArr[i3])) {
                r0.enabledTrackGroupCount--;
                ((HlsSampleStream) sampleStreamArr2[i3]).unbindSampleQueue();
        ...
        if (!z) {
            ...
            while (i < trackSelectionArr2.length) {
                if (sampleStreamArr2[i] == null && trackSelectionArr2[i] != null) {
                    r0.enabledTrackGroupCount++;
                    trackSelection3 = trackSelectionArr2[i];
                    ...
                    sampleStreamArr2[i] = new HlsSampleStream(r0, indexOf);
                    zArr2[i] = true;
            ...
            if (r0.enabledTrackGroupCount != 0) {
                ...
                if (!(r0.mediaChunks.isEmpty() || Util.areEqual(trackSelection2, trackSelection))) {
                    if (!r0.seenFirstTrackSelection) {
                        ...
                        trackSelection2.updateSelectedTrack(j3, j2, C0649C.TIME_UNSET);
    ...
    public boolean continueLoading(long j) {
        if (!this.loadingFinished) {
            if (!r0.loader.isLoading()) {
                ...
                if (z) {
                    r0.pendingResetPositionUs = C0649C.TIME_UNSET;
    ...
    private void buildTracks() {
        ...
        while (true) {
            ...
            if (!MimeTypes.isVideo(str)) {
                obj2 = MimeTypes.isAudio(str) ? 2 : MimeTypes.isText(str) ? 1 : null;
            }
            if (obj2 > obj) {
                i2 = i;
                obj = obj2;
        ...
        for (int i5 = 0; i5 < length; i5++) {
            ...
            if (i5 == i2) {
                ...
                Format format = (obj == 3 && MimeTypes.isAudio(upstreamFormat.sampleMimeType)) ? this.muxedAudioFormat : null;
                trackGroupArr[i5] = new TrackGroup(deriveFormat(format, upstreamFormat, false));
            }
        }
    ...
    private static Format deriveFormat(Format format, Format format2, boolean z) {
        ...
        return format2.copyWithContainerInfo(format.id, z, codecsOfType, i, format.width, format.height, format.selectionFlags, format.language);
    }
