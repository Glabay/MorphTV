...
public class SlidingPercentile {
    private static final Comparator<Sample> INDEX_COMPARATOR = new C07671();
    private static final int MAX_RECYCLED_SAMPLES = 5;
    private static final int SORT_ORDER_BY_INDEX = 1;
    private static final int SORT_ORDER_BY_VALUE = 0;
    private static final int SORT_ORDER_NONE = -1;
    private static final Comparator<Sample> VALUE_COMPARATOR = new C07682();
    ...
    static class C07671 implements Comparator<Sample> {
        C07671() {
        }
    ...
    static class C07682 implements Comparator<Sample> {
        C07682() {
        }
