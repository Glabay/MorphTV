...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0249R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        context = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0249R.styleable.ActionMode, i, 0);
        ViewCompat.setBackground(this, context.getDrawable(C0249R.styleable.ActionMode_background));
        this.mTitleStyleRes = context.getResourceId(C0249R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = context.getResourceId(C0249R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = context.getLayoutDimension(C0249R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = context.getResourceId(C0249R.styleable.ActionMode_closeItemLayout, C0249R.layout.abc_action_mode_close_item_material);
        context.recycle();
    }
