...
public class torrent_finished_alert extends torrent_alert {
    ...
    protected torrent_finished_alert(long j, boolean z) {
        super(libtorrent_jni.torrent_finished_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(torrent_finished_alert torrent_finished_alert) {
        return torrent_finished_alert == null ? 0 : torrent_finished_alert.swigCPtr;
    }
