...
public class DashManifest {
    ...
    public final long getPeriodDurationMs(int i) {
        if (i == this.periods.size() - 1) {
            return this.durationMs == C0649C.TIME_UNSET ? C0649C.TIME_UNSET : this.durationMs - ((Period) this.periods.get(i)).startMs;
        } else {
    ...
    public final long getPeriodDurationUs(int i) {
        return C0649C.msToUs(getPeriodDurationMs(i));
    }
    ...
    public final DashManifest copy(List<RepresentationKey> list) {
        ...
        while (true) {
            ...
            if (((RepresentationKey) linkedList.peek()).periodIndex != i) {
                ...
                if (periodDurationMs != C0649C.TIME_UNSET) {
                    j2 += periodDurationMs;
                }
            } else {
        ...
        if (dashManifest.durationMs != C0649C.TIME_UNSET) {
