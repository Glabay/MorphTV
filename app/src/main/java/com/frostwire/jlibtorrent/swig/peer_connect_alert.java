...
public class peer_connect_alert extends peer_alert {
    ...
    protected peer_connect_alert(long j, boolean z) {
        super(libtorrent_jni.peer_connect_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(peer_connect_alert peer_connect_alert) {
        return peer_connect_alert == null ? 0 : peer_connect_alert.swigCPtr;
    }
