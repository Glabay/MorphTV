...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        context = context.getTheme().obtainStyledAttributes(null, C0249R.styleable.DrawerArrowToggle, C0249R.attr.drawerArrowStyle, C0249R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(context.getColor(C0249R.styleable.DrawerArrowToggle_color, 0));
        setBarThickness(context.getDimension(C0249R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(context.getBoolean(C0249R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize((float) Math.round(context.getDimension(C0249R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = context.getDimensionPixelSize(C0249R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = (float) Math.round(context.getDimension(C0249R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = (float) Math.round(context.getDimension(C0249R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = context.getDimension(C0249R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
        context.recycle();
    }
