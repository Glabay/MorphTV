...
public final class Tables {
    private static final Function<? extends Map<?, ?>, ? extends Map<?, ?>> UNMODIFIABLE_WRAPPER = new C10841();
    ...
    static abstract class AbstractCell<R, C, V> implements Cell<R, C, V> {
        ...
        public boolean equals(Object obj) {
            ...
            Cell cell = (Cell) obj;
            if (!Objects.equal(getRowKey(), cell.getRowKey()) || !Objects.equal(getColumnKey(), cell.getColumnKey()) || Objects.equal(getValue(), cell.getValue()) == null) {
                z = false;
            }
            return z;
        }
    ...
    static class C10841 implements Function<Map<Object, Object>, Map<Object, Object>> {
        C10841() {
        }
    ...
    private static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        class C10851 implements Function<Cell<R, C, V1>, Cell<R, C, V2>> {
            C10851() {
            }
        ...
        class C10862 implements Function<Map<C, V1>, Map<C, V2>> {
            C10862() {
            }
        ...
        class C10873 implements Function<Map<R, V1>, Map<R, V2>> {
            C10873() {
            }
        ...
        public Map<R, Map<C, V2>> rowMap() {
            return Maps.transformValues(this.fromTable.rowMap(), new C10862());
        }

        public Map<C, Map<R, V2>> columnMap() {
            return Maps.transformValues(this.fromTable.columnMap(), new C10873());
        }
    }

    private static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        private static final Function<Cell<?, ?, ?>, Cell<?, ?, ?>> TRANSPOSE_CELL = new C10881();
        final Table<R, C, V> original;

        /* renamed from: com.google.common.collect.Tables$TransposeTable$1 */
        static class C10881 implements Function<Cell<?, ?, ?>, Cell<?, ?, ?>> {
            C10881() {
            }
