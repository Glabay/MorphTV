...
*/
        ...
        private void initInternal(int i) {
            ...
            if (i == 1) {
                ...
                this.pbuffer = EGL14.eglCreatePbufferSurface(this.display, eGLConfig, i == 2 ? new int[]{12375, 1, 12374, 1, DummySurface.EGL_PROTECTED_CONTENT_EXT, 1, 12344} : new int[]{12375, 1, 12374, 1, 12344}, 0);
