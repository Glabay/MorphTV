...
public final class Multimaps {
    ...
    static final class AsMap<K, V> extends ViewCachingAbstractMap<K, Collection<V>> {
        ...
        class EntrySet extends EntrySet<K, Collection<V>> {
            ...
            class C10251 implements Function<K, Collection<V>> {
                C10251() {
                }
            ...
            public Iterator<Entry<K, Collection<V>>> iterator() {
                return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new C10251());
            }
    ...
    private static class MapMultimap<K, V> extends AbstractMultimap<K, V> implements SetMultimap<K, V>, Serializable {
        ...
        public Set<V> get(final K k) {
            return new ImprovedAbstractSet<V>() {
                ...
                class C10281 implements Iterator<V> {
                    /* renamed from: i */
                    int f50i;
                    ...
                    public boolean hasNext() {
                        return this.f50i == 0 && MapMultimap.this.map.containsKey(k);
                    }
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        class C10301 implements EntryTransformer<K, Collection<V1>, Collection<V2>> {
            C10301() {
            }
        ...
        Collection<V2> transform(K k, Collection<V1> collection) {
            k = Maps.asValueToValueFunction(this.transformer, k);
            if (collection instanceof List) {
                return Lists.transform((List) collection, k);
            }
            return Collections2.transform(collection, k);
        }

        Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new C10301());
        }
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        class C10311 implements Function<Collection<V>, Collection<V>> {
            C10311() {
            }
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            map = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new C10311()));
            this.map = map;
            return map;
        }
