...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C03612();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C03601();
    ...
    class C03612 implements OnItemTouchListener {
        C03612() {
        }
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C03671 implements AnimatorUpdateListener {
            C03671() {
            }
    ...
    class C03645 implements ChildDrawingOrderCallback {
        C03645() {
        }
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C03651();
        private static final Interpolator sDragViewScrollCapInterpolator = new C03662();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: android.support.v7.widget.helper.ItemTouchHelper$Callback$1 */
        static class C03651 implements Interpolator {
        ...
        static class C03662 implements Interpolator {
            public float getInterpolation(float f) {
                f -= 1.0f;
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0268R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        public long getAnimationDuration(RecyclerView recyclerView, int i, float f, float f2) {
            ...
            if (recyclerView == null) {
                return i == 8 ? DEFAULT_DRAG_ANIMATION_DURATION : 250;
            }
            if (i == 8) {
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = recyclerView.getDimension(C0268R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = recyclerView.getDimension(C0268R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (viewHolder2 != this.mSelected || i2 != r11.mActionState) {
            ...
            if (r11.mSelected != null) {
                ...
                if (viewHolder3.itemView.getParent() != null) {
                    ...
                    RecoverAnimation c03623 = new RecoverAnimation(viewHolder3, i6, i3, f2, f3, f, signum) {
                        public void onAnimationEnd(Animator animator) {
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C03645();
            }
