...
@TargetApi(16)
public class SimpleExoPlayer implements ExoPlayer, VideoComponent, TextComponent {
    ...
    private final class ComponentListener implements VideoRendererEventListener, AudioRendererEventListener, TextOutput, MetadataOutput, Callback, SurfaceTextureListener {
