...
class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final Long toLongExactOrNull(double d) {
        return (d < ((double) Long.MIN_VALUE) || d > ((double) Long.MAX_VALUE)) ? 0.0d : Long.valueOf((long) d);
    }

    @Nullable
    public static final Long toLongExactOrNull(float f) {
        return (f < ((float) Long.MIN_VALUE) || f > ((float) Long.MAX_VALUE)) ? 0.0f : Long.valueOf((long) f);
    }
