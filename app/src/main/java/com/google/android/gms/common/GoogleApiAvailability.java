        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C0780R.drawable.common_full_open_on_phone, resources.getString(C0780R.string.common_open_on_phone), pendingIntent);
                } else {
