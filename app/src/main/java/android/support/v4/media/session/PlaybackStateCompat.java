...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01411();
    ...
    static class C01411 implements Creator<PlaybackStateCompat> {
        C01411() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01421();
        ...
        static class C01421 implements Creator<CustomAction> {
            C01421() {
            }
    ...
    public static int toKeyCode(long j) {
        return j == 4 ? 126 : j == 2 ? KEYCODE_MEDIA_PAUSE : j == 32 ? 87 : j == 16 ? 88 : j == 1 ? 86 : j == 64 ? 90 : j == 8 ? 89 : j == 512 ? 85 : 0;
    }
