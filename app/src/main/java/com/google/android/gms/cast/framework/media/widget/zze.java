...
final class zze {
    ...
    public static Bitmap zza(Context context, Bitmap bitmap, float f, float f2) {
        zzbd.m25d("Begin blurring bitmap %s, original width = %d, original height = %d.", bitmap, Integer.valueOf(bitmap.getWidth()), Integer.valueOf(bitmap.getHeight()));
        ...
        create.destroy();
        zzbd.m25d("End blurring bitmap %s, original width = %d, original height = %d.", bitmap, Integer.valueOf(round), Integer.valueOf(round2));
        return createBitmap;
    }
