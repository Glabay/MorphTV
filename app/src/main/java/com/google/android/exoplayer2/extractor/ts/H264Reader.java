    ...
    private void endNalUnit(long j, int i, int i2, long j2) {
        ...
        if (!this.hasOutputFormat || r0.sampleReader.needsSpsPps()) {
            ...
            if (r0.hasOutputFormat) {
                ...
                r0.output.format(Format.createVideoSampleFormat(r0.formatId, MimeTypes.VIDEO_H264, null, -1, -1, parseSpsNalUnit.width, parseSpsNalUnit.height, -1.0f, arrayList, -1, parseSpsNalUnit.pixelWidthAspectRatio, null));
