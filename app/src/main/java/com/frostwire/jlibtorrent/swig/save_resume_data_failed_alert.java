...
public class save_resume_data_failed_alert extends torrent_alert {
    ...
    protected save_resume_data_failed_alert(long j, boolean z) {
        super(libtorrent_jni.save_resume_data_failed_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(save_resume_data_failed_alert save_resume_data_failed_alert) {
        return save_resume_data_failed_alert == null ? 0 : save_resume_data_failed_alert.swigCPtr;
    }
