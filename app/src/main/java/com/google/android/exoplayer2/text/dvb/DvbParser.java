...
final class DvbParser {
    ...
    private static final byte[] defaultMap2To4 = new byte[]{(byte) 0, (byte) 7, (byte) 8, Ascii.SI};
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int i) {
        ...
        while (i4 > 0) {
            ...
            iArr[readBits5] = getColor((byte) (255 - (readBits4 & 255)), Util.constrainValue((int) (d + (1.402d * d2)), 0, 255), Util.constrainValue((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 0, 255), Util.constrainValue((int) (d + (d3 * 1.772d)), 0, 255));
            i4 = i5;
            readBits = i6;
            i2 = 8;
            i3 = 2;
                    ...
                    if (!parsableBitArray2.readBit()) {
                        switch (parsableBitArray2.readBits(2)) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                readBits = parsableBitArray2.readBits(4) + 12;
                                i5 = parsableBitArray2.readBits(2);
                                break;
                            case 3:
                                readBits = parsableBitArray2.readBits(8) + 29;
                                i5 = parsableBitArray2.readBits(2);
                                break;
                            default:
                                obj2 = obj;
                    ...
                    if (parsableBitArray2.readBit()) {
                        switch (parsableBitArray2.readBits(2)) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                readBits = parsableBitArray2.readBits(4) + 9;
                                i5 = parsableBitArray2.readBits(4);
                                break;
                            case 3:
                                readBits = parsableBitArray2.readBits(8) + 25;
                                i5 = parsableBitArray2.readBits(4);
                                break;
                            default:
                                obj2 = obj;
