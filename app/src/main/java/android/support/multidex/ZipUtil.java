...
final class ZipUtil {
    ...
    static long getZipCrc(File file) throws IOException {
        long j = InternalZipConstants.READ_MODE;
    ...
    static CentralDirectory findCentralDirectory(RandomAccessFile randomAccessFile) throws IOException, ZipException {
        ...
        while (true) {
            ...
            if (randomAccessFile.readInt() == reverseBytes) {
                ...
                centralDirectory.size = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & InternalZipConstants.ZIP_64_LIMIT;
                centralDirectory.offset = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & InternalZipConstants.ZIP_64_LIMIT;
