...
public final class PsExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new C06961();
    ...
    /* renamed from: com.google.android.exoplayer2.extractor.ts.PsExtractor$1 */
    static class C06961 implements ExtractorsFactory {
        C06961() {
        }
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        if (PACK_START_CODE != (((((bArr[0] & 255) << 24) | ((bArr[1] & 255) << 16)) | ((bArr[2] & 255) << 8)) | (bArr[3] & 255)) || (bArr[4] & EUCTWDistributionAnalysis.HIGHBYTE_BEGIN) != 68 || (bArr[6] & 4) != 4 || (bArr[8] & 4) != 4 || (bArr[9] & 1) != 1 || (bArr[12] & 3) != 3) {
            return false;
        }
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException, InterruptedException {
        ...
        if (positionHolder == PACK_START_CODE) {
            ...
            return 0;
        } else if (((positionHolder & InputDeviceCompat.SOURCE_ANY) >> 8) != 1) {
            ...
            if (!this.foundAllTracks) {
                if (pesReader == null) {
                    ...
                    } else if (!this.foundAudioTrack && (positionHolder & 224) == 192) {
                        elementaryStreamReader = new MpegAudioReader();
                        this.foundAudioTrack = true;
                    } else if (!this.foundVideoTrack && (positionHolder & 240) == 224) {
                ...
                if (!(this.foundAudioTrack == null || this.foundVideoTrack == null) || extractorInput.getPosition() > 1048576) {
