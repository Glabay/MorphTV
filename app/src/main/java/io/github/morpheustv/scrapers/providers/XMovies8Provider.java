...
public class XMovies8Provider extends BaseProvider {
    String base_link;
    String[] domains;

    public XMovies8Provider(Scraper scraper) {
        super(scraper, "XMOVIES8", true);
        this.domains = new String[]{"xmovies8.unblockall.org"};
        this.base_link = "http://xmovies8.unblockall.org";
...
*/
    ...
    L_0x0119:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: io.github.morpheustv.scrapers.providers.XMovies8Provider.getSources(io.github.morpheustv.scrapers.model.ProviderSearchResult, java.util.concurrent.CopyOnWriteArrayList):void");
    }
}
