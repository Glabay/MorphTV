...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02452();
    private final Runnable mMenuInvalidator = new C02441();
    ...
    class C02452 implements OnMenuItemClickListener {
        C02452() {
        }
