...
class DefaultDrmSession<T extends ExoMediaCrypto> implements DrmSession<T> {
    ...
    /* renamed from: com.google.android.exoplayer2.drm.DefaultDrmSession$1 */
    ...
    /* renamed from: com.google.android.exoplayer2.drm.DefaultDrmSession$2 */
    ...
    /* renamed from: com.google.android.exoplayer2.drm.DefaultDrmSession$3 */
                ...
                if (this.offlineLicenseKeySetId == null) {
                    ...
                    if (this.mode == 0 && licenseDurationRemainingSec <= 60) {
                        ...
                        if (this.eventHandler && this.eventListener) {
                            this.eventHandler.post(new C06721());
                            return;
                        }
                        return;
                    }
    ...
    private long getLicenseDurationRemainingSec() {
        if (!C0649C.WIDEVINE_UUID.equals(this.uuid)) {
    ...
    private void postKeyRequest(int i, boolean z) {
        try {
            ...
            if (C0649C.CLEARKEY_UUID.equals(this.uuid)) {
        ...
        try {
            ...
            if (this.mode == 3) {
                ...
                if (!(this.eventHandler == null || this.eventListener == null)) {
                    this.eventHandler.post(new C06732());
                }
            } else {
                ...
                this.state = 4;
                if (!(this.eventHandler == null || this.eventListener == null)) {
                    this.eventHandler.post(new C06743());
                }
            }
        } catch (Object obj2) {
            onKeysError(obj2);
