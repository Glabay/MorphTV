...
public class StrTokenizer implements ListIterator<String>, Cloneable {
    ...
    private int readNextToken(char[] cArr, int i, int i2, StrBuilder strBuilder, List<String> list) {
        while (i < i2) {
            ...
            if (max == 0 || getDelimiterMatcher().isMatch(cArr, i, i, i2) > 0) {
                break;
            } else if (getQuoteMatcher().isMatch(cArr, i, i, i2) > 0) {
                break;
            } else {
                i += max;
            }
        ...
        max = getDelimiterMatcher().isMatch(cArr, i, i, i2);
        if (max > 0) {
            addToken(list, "");
            return i + max;
        }
        int isMatch = getQuoteMatcher().isMatch(cArr, i, i, i2);
        if (isMatch <= 0) {
            return readWithQuotes(cArr, i, i2, strBuilder, list, 0, 0);
        }
        return readWithQuotes(cArr, i + isMatch, i2, strBuilder, list, i, isMatch);
    }
    ...
    private int readWithQuotes(char[] cArr, int i, int i2, StrBuilder strBuilder, List<String> list, int i3, int i4) {
        ...
        while (i8 < i6) {
            ...
            if (obj != null) {
                i11 = i9;
                if (isQuote(cArr2, i8, i6, i3, i7)) {
                    int i12 = i8 + i7;
                    if (isQuote(cArr2, i12, i6, i3, i7)) {
                        strBuilder2.append(cArr2, i8, i7);
                        i8 += i7 * 2;
                        i9 = strBuilder.size();
                    } else {
                        i9 = i11;
                    ...
                    i10 = i8 + 1;
                    strBuilder2.append(cArr2[i8]);
                    i9 = strBuilder.size();
                }
            } else {
                i11 = i9;
                i10 = getDelimiterMatcher().isMatch(cArr2, i8, i5, i6);
                if (i10 > 0) {
                    addToken(list2, strBuilder2.substring(0, i11));
                    return i8 + i10;
                } else if (i7 <= 0 || !isQuote(cArr2, i8, i6, i3, i7)) {
                    i10 = getIgnoredMatcher().isMatch(cArr2, i8, i5, i6);
                    if (i10 > 0) {
                        i8 += i10;
                    } else {
                        i10 = getTrimmerMatcher().isMatch(cArr2, i8, i5, i6);
                        if (i10 > 0) {
                            strBuilder2.append(cArr2, i8, i10);
                            i8 += i10;
                        } else {
                            i10 = i8 + 1;
                            strBuilder2.append(cArr2[i8]);
...
*/
        /*
        r1 = this;
        r0 = r1.cloneReset();	 Catch:{ CloneNotSupportedException -> 0x0005 }
        return r0;
    L_0x0005:
        r0 = 0;
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.lang3.text.StrTokenizer.clone():java.lang.Object");
    }
