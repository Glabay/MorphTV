...
public final class Lists {
    ...
    private static class ReverseList<T> extends AbstractList<T> {
        ...
        public ListIterator<T> listIterator(int i) {
            i = this.forwardList.listIterator(reversePosition(i));
            return new ListIterator<T>() {
                ...
                public int nextIndex() {
                    return ReverseList.this.reversePosition(i.nextIndex());
                }
    ...
    static boolean equalsImpl(List<?> list, @Nullable Object obj) {
        ...
        List list2 = (List) obj;
        if (list.size() != list2.size() || Iterators.elementsEqual(list.iterator(), list2.iterator()) == null) {
            z = false;
        }
        return z;
    }
    ...
    static <E> List<E> subListImpl(List<E> list, int i, int i2) {
        List c09601;
        if (list instanceof RandomAccess) {
            c09601 = new RandomAccessListWrapper<E>(list) {
                private static final long serialVersionUID = 0;
            ...
            c09601 = new AbstractListWrapper<E>(list) {
                private static final long serialVersionUID = 0;
