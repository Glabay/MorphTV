            ...
            if (!(indexOf == -1 || indexOf == 0)) {
                if (indexOf != str.length() - 1) {
                    ...
                    if ("Content-Type".equalsIgnoreCase(substring)) {
                        ...
                        headers$Builder.add(substring, str);
                    }
                    i++;
                }
            }
    ...
    private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
        if (annotation instanceof Url) {
            ...
            if (this.gotQuery) {
                ...
                return new ParameterHandler.Path(r0, this.retrofit.stringConverter(type, annotationArr), path.encoded());
            }
            ...
            if (Iterable.class.isAssignableFrom(r3)) {
                if (type instanceof ParameterizedType) {
                    return new ParameterHandler.Query(r0, this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type), annotationArr), annotation).iterable();
                }
                ...
                return new ParameterHandler.Query(r0, this.retrofit.stringConverter(type, annotationArr), annotation);
            } else {
                return new ParameterHandler.Query(r0, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(r3.getComponentType()), annotationArr), annotation).array();
            }
            ...
            if (Iterable.class.isAssignableFrom(r0)) {
                if (type instanceof ParameterizedType) {
                    return new ParameterHandler.QueryName(this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type), annotationArr), annotation).iterable();
                }
                type = new StringBuilder();
                ...
                return new ParameterHandler.QueryName(this.retrofit.stringConverter(type, annotationArr), annotation);
            } else {
                return new ParameterHandler.QueryName(this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(r0.getComponentType()), annotationArr), annotation).array();
            }
            ...
            if (Map.class.isAssignableFrom(r0)) {
                ...
                if (type instanceof ParameterizedType) {
                    ...
                    return new ParameterHandler.QueryMap(this.retrofit.stringConverter(Utils.getParameterUpperBound(1, r9), annotationArr), ((QueryMap) annotation).encoded());
                }
            ...
            if (Iterable.class.isAssignableFrom(r0)) {
                if (type instanceof ParameterizedType) {
                    return new ParameterHandler.Header(annotation, this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type), annotationArr)).iterable();
                }
                type = new StringBuilder();
                type.append(r0.getSimpleName());
                type.append(" must include generic type (e.g., ");
                ...
                return new ParameterHandler.Header(annotation, this.retrofit.stringConverter(type, annotationArr));
            } else {
                return new ParameterHandler.Header(annotation, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(r0.getComponentType()), annotationArr)).array();
            }
            ...
            if (Map.class.isAssignableFrom(annotation)) {
                ...
                return new ParameterHandler.HeaderMap(this.retrofit.stringConverter(Utils.getParameterUpperBound(1, r9), annotationArr));
            }
            ...
            if (this.isFormEncoded) {
                ...
                if (Iterable.class.isAssignableFrom(rawType)) {
                    if (type instanceof ParameterizedType) {
                        return new ParameterHandler.Field(r0, this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type), annotationArr), annotation).iterable();
                    }
                    type = new StringBuilder();
                    ...
                    return new ParameterHandler.Field(r0, this.retrofit.stringConverter(type, annotationArr), annotation);
                } else {
                    return new ParameterHandler.Field(r0, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawType.getComponentType()), annotationArr), annotation).array();
                }
            }
            ...
            if (this.isFormEncoded) {
                ...
                if (Map.class.isAssignableFrom(r0)) {
                    ...
                    if (type instanceof ParameterizedType) {
                        ...
                        this.gotField = true;
                        return new ParameterHandler.FieldMap(i, ((FieldMap) annotation).encoded());
                    }
                    throw parameterError(i, "Map must include generic types (e.g., Map<String, String>)", new Object[0]);
                }
                    ...
                    if (Iterable.class.isAssignableFrom(r3)) {
                        if (type instanceof ParameterizedType) {
                            ...
                            if (!MultipartBody.Part.class.isAssignableFrom(Utils.getRawType(type))) {
                                return new ParameterHandler.Part(annotation, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations)).iterable();
                            }
                        ...
                        if (!MultipartBody.Part.class.isAssignableFrom(type)) {
                            return new ParameterHandler.Part(annotation, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations)).array();
                        }
                        throw parameterError(i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                    } else if (!MultipartBody.Part.class.isAssignableFrom(r3)) {
                        return new ParameterHandler.Part(annotation, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                    } else {
                        throw parameterError(i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                    }
            ...
            if (this.isFormEncoded == null) {
                if (this.isMultipart == null) {
                    ...
                    try {
                        ...
                        this.gotBody = true;
                        return new ParameterHandler.Body(annotationArr);
