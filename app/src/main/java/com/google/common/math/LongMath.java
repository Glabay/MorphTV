...
public final class LongMath {
    ...
    static final int[] biggestBinomials = new int[]{Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, 206, 169, EUCJPContextAnalysis.SINGLE_SHIFT_3, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    @VisibleForTesting
    ...
    @GwtIncompatible("TODO")
    @VisibleForTesting
    static final long[] powersOf10 = new long[]{1, 10, 100, 1000, NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS, 100000, C0649C.MICROS_PER_SECOND, 10000000, 100000000, C0649C.NANOS_PER_SECOND, 10000000000L, 100000000000L, 1000000000000L, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
...
*/
    ...
    public static int log2(long j, RoundingMode roundingMode) {
        ...
        switch (C11771.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
            ...
            case 7:
            case 8:
                roundingMode = Long.numberOfLeadingZeros(j);
                return (63 - roundingMode) + lessThanBranchFree(MAX_POWER_OF_SQRT2_UNSIGNED >>> roundingMode, j);
            default:
    ...
    public static int log10(long j, RoundingMode roundingMode) {
        ...
        switch (C11771.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
                MathPreconditions.checkRoundingUnnecessary(j == j2 ? 1 : null);
                break;
            case 2:
            case 3:
                break;
    ...
    L_0x0010:
        ...
        r11 = 1;
        r10 = r10 | r11;
        r6 = com.google.common.math.LongMath.C11771.$SwitchMap$java$math$RoundingMode;
        r7 = r14.ordinal();
        r6 = r6[r7];
        r7 = 0;
        switch(r6) {
    ...
    L_0x0066:
        r11 = 0;
    L_0x0067:
        com.google.common.math.MathPreconditions.checkRoundingUnnecessary(r11);
    L_0x006a:
        r11 = 0;
    L_0x006b:
