...
public class peer_snubbed_alert extends peer_alert {
    ...
    protected peer_snubbed_alert(long j, boolean z) {
        super(libtorrent_jni.peer_snubbed_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(peer_snubbed_alert peer_snubbed_alert) {
        return peer_snubbed_alert == null ? 0 : peer_snubbed_alert.swigCPtr;
    }
