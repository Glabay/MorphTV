...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C12861();
    ...
    static class C12861 implements Comparator<Comparable> {
        C12861() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C12871 extends LinkedTreeMapIterator<Entry<K, V>> {
            C12871() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C12881 extends LinkedTreeMapIterator<K> {
            C12881() {
                super();
            }
