...
public final class FlvExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new C06831();
    ...
    private long mediaTagTimestampOffsetUs = C0649C.TIME_UNSET;
    ...
    /* renamed from: com.google.android.exoplayer2.extractor.flv.FlvExtractor$1 */
    static class C06831 implements ExtractorsFactory {
        C06831() {
        }
    ...
    public void seek(long j, long j2) {
        this.state = 1;
        this.mediaTagTimestampOffsetUs = C0649C.TIME_UNSET;
    ...
    private boolean readTagData(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        if (this.tagType == 8 && this.audioReader != null) {
            ...
            if (durationUs != C0649C.TIME_UNSET) {
    ...
    private void ensureReadyForMediaOutput() {
        if (!this.outputSeekMap) {
            this.extractorOutput.seekMap(new Unseekable(C0649C.TIME_UNSET));
            this.outputSeekMap = true;
        }
        if (this.mediaTagTimestampOffsetUs == C0649C.TIME_UNSET) {
            this.mediaTagTimestampOffsetUs = this.metadataReader.getDurationUs() == C0649C.TIME_UNSET ? -this.tagTimestampUs : 0;
        }
    }
}
