...
public final class UriUtil {
    ...
    public static String resolve(String str, String str2) {
        ...
        } else if (str2.charAt(uriIndices[1]) == IOUtils.DIR_SEPARATOR_UNIX) {
    ...
    private static String removeDotSegments(StringBuilder stringBuilder, int i, int i2) {
        ...
        while (true) {
            ...
            while (i2 <= i4) {
                ...
                if (i2 == i4) {
                    i5 = i2;
                } else if (stringBuilder.charAt(i2) == IOUtils.DIR_SEPARATOR_UNIX) {
                    i5 = i2 + 1;
                } else {
                    i2++;
                }
    ...
    private static int[] getUriIndices(String str) {
        ...
        indexOf2 = indexOf3 + 2;
        Object obj = (indexOf2 < indexOf && str.charAt(indexOf3 + 1) == IOUtils.DIR_SEPARATOR_UNIX && str.charAt(indexOf2) == IOUtils.DIR_SEPARATOR_UNIX) ? 1 : null;
        if (obj != null) {
