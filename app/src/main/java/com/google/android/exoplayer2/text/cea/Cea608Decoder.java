...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static final int[] SPECIAL_CHARACTER_SET = new int[]{174, 176, PsExtractor.PRIVATE_STREAM_1, 191, 8482, 162, 163, 9834, 224, 32, 232, 226, HebrewProber.FINAL_KAF, HebrewProber.NORMAL_MEM, HebrewProber.NORMAL_PE, 251};
    private static final int[] SPECIAL_ES_FR_CHARACTER_SET = new int[]{193, 201, 211, 218, 220, 252, 8216, 161, 42, 39, 8212, 169, 8480, 8226, 8220, 8221, 192, 194, 199, Callback.DEFAULT_DRAG_ANIMATION_DURATION, 202, 203, HebrewProber.NORMAL_KAF, 206, 207, 239, 212, 217, 249, 219, 171, 187};
    private static final int[] SPECIAL_PT_DE_CHARACTER_SET = new int[]{195, 227, 205, 204, 236, 210, 242, 213, HebrewProber.FINAL_TSADI, 123, 125, 92, 94, 95, ModelPPM.MAX_FREQ, Big5DistributionAnalysis.LOWBYTE_END_1, EUCTWDistributionAnalysis.HIGHBYTE_BEGIN, 228, 214, HebrewProber.NORMAL_TSADI, 223, 165, 164, 9474, 197, 229, 216, 248, 9484, 9488, 9492, 9496};
                ...
                if (this.selectedField != 1 || (i & 1) == 0) {
                    if (this.selectedField != 2 || (i & 1) == 1) {
                        if (readUnsignedByte != (byte) 0 || readUnsignedByte2 != (byte) 0) {
                            ...
                            } else if ((readUnsignedByte & HebrewProber.NORMAL_TSADI) == 18 && (readUnsignedByte2 & 224) == 32) {
