...
public class Logger {
    ...
    /* renamed from: d */
    public void m14d(String str, Throwable th, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    /* renamed from: d */
    public void m15d(String str, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    /* renamed from: e */
    public void m16e(String str, Throwable th, @Nullable Object... objArr) {
        Log.e(this.mTag, format(str, objArr), th);
    }

    /* renamed from: e */
    public void m17e(String str, @Nullable Object... objArr) {
    ...
    /* renamed from: i */
    public void m18i(String str, Throwable th, @Nullable Object... objArr) {
        Log.i(this.mTag, format(str, objArr), th);
    }

    /* renamed from: i */
    public void m19i(String str, @Nullable Object... objArr) {
    ...
    /* renamed from: v */
    public void m20v(String str, Throwable th, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    /* renamed from: v */
    public void m21v(String str, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    /* renamed from: w */
    public void m22w(String str, Throwable th, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr), th);
    }

    /* renamed from: w */
    public void m23w(String str, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr));
    }

    /* renamed from: w */
    public void m24w(Throwable th) {
        Log.w(this.mTag, th);
    }
