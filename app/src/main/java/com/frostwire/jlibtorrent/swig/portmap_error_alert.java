...
public class portmap_error_alert extends alert {
    ...
    protected portmap_error_alert(long j, boolean z) {
        super(libtorrent_jni.portmap_error_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(portmap_error_alert portmap_error_alert) {
        return portmap_error_alert == null ? 0 : portmap_error_alert.swigCPtr;
    }
    ...
    public int getMap_type() {
        return libtorrent_jni.portmap_error_alert_map_type_get(this.swigCPtr, this);
    }
