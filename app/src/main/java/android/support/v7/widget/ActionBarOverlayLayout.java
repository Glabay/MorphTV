...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C02881 extends AnimatorListenerAdapter {
        C02881() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C02881();
        this.mRemoveActionBarHideOffset = new C02892();
        this.mAddActionBarHideOffset = new C02903();
        init(context);
