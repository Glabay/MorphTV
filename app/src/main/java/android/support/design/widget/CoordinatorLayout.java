...
import android.support.coreui.C0026R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        static class C00291 implements ClassLoaderCreator<SavedState> {
            C00291() {
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        int i2 = 0;
        if (i == 0) {
            attributeSet = context.obtainStyledAttributes(attributeSet, C0026R.styleable.CoordinatorLayout, 0, C0026R.style.Widget_Support_CoordinatorLayout);
        } else {
            attributeSet = context.obtainStyledAttributes(attributeSet, C0026R.styleable.CoordinatorLayout, i, 0);
        }
        i = attributeSet.getResourceId(C0026R.styleable.CoordinatorLayout_keylines, 0);
        if (i != 0) {
        ...
        this.mStatusBarBackground = attributeSet.getDrawable(C0026R.styleable.CoordinatorLayout_statusBarBackground);
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i7)) {
                    Behavior behavior = layoutParams.getBehavior();
                    if (behavior != null) {
                        behavior.onNestedScroll(r9, childAt, view, i, i2, i3, i4, i7);
                        obj = 1;
                    }
                }
            }
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i3)) {
                    ...
                    if (behavior != null) {
                        ...
                        if (i > 0) {
                            max = Math.max(i4, r8.mTempIntPair[0]);
                        } else {
                            max = Math.min(i4, r8.mTempIntPair[0]);
                        }
                        if (i2 > 0) {
                            max2 = Math.max(i5, r8.mTempIntPair[1]);
                        } else {
                            max2 = Math.min(i5, r8.mTempIntPair[1]);
                        }
                        i4 = max;
                        i5 = max2;
                        obj = 1;
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C00281();
                }
