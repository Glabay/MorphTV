...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final int indexOf(@NotNull CharSequence charSequence, @NotNull String str, int i, boolean z) {
        Intrinsics.checkParameterIsNotNull(charSequence, "$receiver");
        Intrinsics.checkParameterIsNotNull(str, SerializerHandler.TYPE_STRING);
        if (!z) {
            if (charSequence instanceof String) {
    ...
    public static final Sequence<String> splitToSequence(@NotNull CharSequence charSequence, @NotNull String[] strArr, boolean z, int i) {
        ...
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, strArr, 0, z, i, 2, null), (Function1) new StringsKt__StringsKt$splitToSequence$1(charSequence));
    }
...
*/
    ...
    public static final Sequence<String> splitToSequence(@NotNull CharSequence charSequence, @NotNull char[] cArr, boolean z, int i) {
        ...
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, cArr, 0, z, i, 2, null), (Function1) new StringsKt__StringsKt$splitToSequence$2(charSequence));
    }
...
*/
    ...
    public static final CharSequence trim(@NotNull CharSequence charSequence, @NotNull char... cArr) {
        ...
        Object obj = null;
        while (i <= length) {
            boolean contains = ArraysKt.contains(cArr, charSequence.charAt(obj == null ? i : length));
            if (obj == null) {
                if (contains) {
                    i++;
                } else {
    ...
    public static final CharSequence trim(@NotNull CharSequence charSequence) {
        ...
        Object obj = null;
        while (i <= length) {
            boolean isWhitespace = CharsKt.isWhitespace(charSequence.charAt(obj == null ? i : length));
            if (obj == null) {
                if (isWhitespace) {
                    i++;
                } else {
