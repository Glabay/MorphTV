...
public abstract class MediaCodecRenderer extends BaseRenderer {
                ...
                if (this.drmSession != null) {
                    ...
                    if (frameworkMediaCrypto != null) {
                        ...
                        if (!shouldInitCodec(this.codecInfo)) {
                            ...
                            this.codecHotswapDeadlineMs = getState() != 2 ? SystemClock.elapsedRealtime() + 1000 : C0649C.TIME_UNSET;
                            resetInputBuffer();
                            resetOutputBuffer();
    ...
    protected void releaseCodec() {
        this.codecHotswapDeadlineMs = C0649C.TIME_UNSET;
        resetInputBuffer();
        resetOutputBuffer();
    ...
    public boolean isReady() {
        return (this.format == null || this.waitingForKeys || (!isSourceReady() && !hasOutputBuffer() && (this.codecHotswapDeadlineMs == C0649C.TIME_UNSET || SystemClock.elapsedRealtime() >= this.codecHotswapDeadlineMs))) ? false : true;
    }

    private boolean drainOutputBuffer(long r16, long r18) throws com.google.android.exoplayer2.ExoPlaybackException {
