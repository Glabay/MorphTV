...
public class SolarMovieProvider extends BaseProvider {
    String base_link;
    String[] domains;

    public SolarMovieProvider(Scraper scraper) {
        super(scraper, "SOLARMOVIEZ.RU", true);
        this.domains = new String[]{"solarmoviez.ru"};
        this.base_link = "https://solarmoviez.ru";
...
*/
    ...
    L_0x0213:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: io.github.morpheustv.scrapers.providers.SolarMovieProvider.getSources(io.github.morpheustv.scrapers.model.ProviderSearchResult, java.util.concurrent.CopyOnWriteArrayList):void");
    }
}
