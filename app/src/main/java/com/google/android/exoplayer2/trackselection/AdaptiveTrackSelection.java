...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public static final class Factory implements com.google.android.exoplayer2.trackselection.TrackSelection.Factory {
        ...
        public Factory(BandwidthMeter bandwidthMeter) {
            this(bandwidthMeter, AdaptiveTrackSelection.DEFAULT_MAX_INITIAL_BITRATE, 10000, 25000, 25000, 0.75f, 0.75f, 2000, Clock.DEFAULT);
        }

        public Factory(BandwidthMeter bandwidthMeter, int i, int i2, int i3, int i4, float f) {
            this(bandwidthMeter, i, i2, i3, i4, f, 0.75f, 2000, Clock.DEFAULT);
        }
    ...
    public AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthMeter bandwidthMeter) {
        this(trackGroup, iArr, bandwidthMeter, DEFAULT_MAX_INITIAL_BITRATE, NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS, 25000, 25000, 0.75f, 0.75f, 2000, Clock.DEFAULT);
    }
    ...
    public void enable() {
        this.lastBufferEvaluationMs = C0649C.TIME_UNSET;
    }
    ...
    public int evaluateQueueSize(long j, List<? extends MediaChunk> list) {
        ...
        if (this.lastBufferEvaluationMs != C0649C.TIME_UNSET && elapsedRealtime - this.lastBufferEvaluationMs < this.minTimeBetweenBufferReevaluationMs) {
            return list.size();
        }
    ...
    private long minDurationForQualityIncreaseUs(long j) {
        Object obj = (j == C0649C.TIME_UNSET || j > this.minDurationForQualityIncreaseUs) ? null : 1;
