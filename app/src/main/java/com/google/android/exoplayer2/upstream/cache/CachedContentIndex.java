...
*/
    ...
    L_0x005f:
        ...
        r3 = 0;	 Catch:{ FileNotFoundException -> 0x00a5, IOException -> 0x008e, all -> 0x008b }
        r5 = 0;	 Catch:{ FileNotFoundException -> 0x00a5, IOException -> 0x008e, all -> 0x008b }
    L_0x0065:
        if (r3 >= r2) goto L_0x0077;	 Catch:{ FileNotFoundException -> 0x00a5, IOException -> 0x008e, all -> 0x008b }
    L_0x0067:
        r6 = new com.google.android.exoplayer2.upstream.cache.CachedContent;	 Catch:{ FileNotFoundException -> 0x00a5, IOException -> 0x008e, all -> 0x008b }
