...
public final class VideoFrameReleaseTimeHelper {
    ...
    private static final class VSyncSampler implements FrameCallback, Callback {
        ...
        public volatile long sampledVsyncTimeNs = C0649C.TIME_UNSET;
        ...
        private void removeObserverInternal() {
            ...
            if (this.observerCount == 0) {
                ...
                this.sampledVsyncTimeNs = C0649C.TIME_UNSET;
            }
        }
    }
    ...
    public VideoFrameReleaseTimeHelper(@Nullable Context context) {
        ...
        this.vsyncDurationNs = C0649C.TIME_UNSET;
        this.vsyncOffsetNs = C0649C.TIME_UNSET;
    }
            ...
            if (r0.frameCount >= 6) {
                ...
                if (isDriftTooLarge(j3, j6)) {
                    ...
                    if (r0.vsyncSampler != null) {
                        if (r0.vsyncDurationNs == C0649C.TIME_UNSET) {
                            j5 = r0.vsyncSampler.sampledVsyncTimeNs;
                            if (j5 != C0649C.TIME_UNSET) {
                                return j4;
                            }
