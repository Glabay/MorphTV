...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03373 implements OnFocusChangeListener {
        C03373() {
        }
    ...
    class C03384 implements OnLayoutChangeListener {
        C03384() {
        }
    ...
    class C03406 implements OnKeyListener {
        C03406() {
        }
    ...
    class C03417 implements OnEditorActionListener {
        C03417() {
        }
    ...
    class C03428 implements OnItemClickListener {
        C03428() {
        }
    ...
    class C03439 implements OnItemSelectedListener {
...
*/
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C03441();
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C03441 implements ClassLoaderCreator<SavedState> {
            C03441() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0249R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            super(context, attributeSet, i);
            this.mRunShowSoftInputIfNecessary = new C03451();
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0249R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C03351();
        this.mReleaseCursorRunnable = new C03362();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03395();
        this.mTextKeyListener = new C03406();
        this.mOnEditorActionListener = new C03417();
        this.mOnItemClickListener = new C03428();
        this.mOnItemSelectedListener = new C03439();
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0249R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(attributeSet.getResourceId(C0249R.styleable.SearchView_layout, C0249R.layout.abc_search_view), this, true);
        ...
        ViewCompat.setBackground(this.mSearchPlate, attributeSet.getDrawable(C0249R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, attributeSet.getDrawable(C0249R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(attributeSet.getDrawable(C0249R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(attributeSet.getDrawable(C0249R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(attributeSet.getDrawable(C0249R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(attributeSet.getDrawable(C0249R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(attributeSet.getDrawable(C0249R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = attributeSet.getDrawable(C0249R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0249R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = attributeSet.getResourceId(C0249R.styleable.SearchView_suggestionRowLayout, C0249R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = attributeSet.getResourceId(C0249R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03373());
        setIconifiedByDefault(attributeSet.getBoolean(C0249R.styleable.SearchView_iconifiedByDefault, true));
        context = attributeSet.getDimensionPixelSize(C0249R.styleable.SearchView_android_maxWidth, -1);
        if (context != -1) {
            setMaxWidth(context);
        }
        this.mDefaultQueryHint = attributeSet.getText(C0249R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = attributeSet.getText(C0249R.styleable.SearchView_queryHint);
        context = attributeSet.getInt(C0249R.styleable.SearchView_android_imeOptions, -1);
        if (context != -1) {
            setImeOptions(context);
        }
        context = attributeSet.getInt(C0249R.styleable.SearchView_android_inputType, -1);
        if (context != -1) {
            setInputType(context);
        }
        setFocusable(attributeSet.getBoolean(C0249R.styleable.SearchView_android_focusable, true));
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C03384());
        }
...
*/
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0249R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0249R.dimen.abc_dropdownitem_text_padding_left) : 0;
