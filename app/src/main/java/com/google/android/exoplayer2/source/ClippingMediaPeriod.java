...
public final class ClippingMediaPeriod implements MediaPeriod, Callback {
    ...
    public ClippingMediaPeriod(MediaPeriod mediaPeriod, boolean z) {
        ...
        this.pendingInitialDiscontinuityPositionUs = z ? 0 : -9223372036854775807;
        this.startUs = C0649C.TIME_UNSET;
        this.endUs = C0649C.TIME_UNSET;
    }
    ...
    public long selectTracks(TrackSelection[] trackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        long j2 = (isPendingInitialDiscontinuity() && j == 0 && shouldKeepInitialDiscontinuity(r0.startUs, trackSelectionArr)) ? selectTracks : C0649C.TIME_UNSET;
    ...
    public long readDiscontinuity() {
        ...
        if (isPendingInitialDiscontinuity()) {
            ...
            this.pendingInitialDiscontinuityPositionUs = C0649C.TIME_UNSET;
    ...
    public void onPrepared(MediaPeriod mediaPeriod) {
        mediaPeriod = (this.startUs == C0649C.TIME_UNSET || this.endUs == C0649C.TIME_UNSET) ? null : true;
    ...
    boolean isPendingInitialDiscontinuity() {
        return this.pendingInitialDiscontinuityPositionUs != C0649C.TIME_UNSET;
    }
