...
public class DeflaterOutputStream extends CipherOutputStream {
    ...
    private boolean firstBytesRead = null;
    ...
    public void putNextEntry(File file, ZipParameters zipParameters) throws ZipException {
        ...
        if (zipParameters.getCompressionMethod() == 8) {
            this.deflater.reset();
            if ((zipParameters.getCompressionLevel() < null || zipParameters.getCompressionLevel() > 9) && zipParameters.getCompressionLevel() != -1) {
    ...
    public void write(byte[] bArr, int i, int i2) throws IOException {
        ...
        while (this.deflater.needsInput() == null) {
            deflate();
        }
    }
