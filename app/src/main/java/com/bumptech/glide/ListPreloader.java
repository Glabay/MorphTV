...
public class ListPreloader<T> implements OnScrollListener {
    ...
    class C05691 implements PreloadModelProvider<T> {
        C05691() {
        }
    ...
    class C05702 implements PreloadSizeProvider<T> {
        C05702() {
        }
    ...
    public ListPreloader(int i) {
        ...
        this.preloadModelProvider = new C05691();
        this.preloadDimensionProvider = new C05702();
        this.maxPreload = i;
