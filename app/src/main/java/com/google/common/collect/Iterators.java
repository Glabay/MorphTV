...
public final class Iterators {
    static final UnmodifiableListIterator<Object> EMPTY_LIST_ITERATOR = new C09431();
    private static final Iterator<Object> EMPTY_MODIFIABLE_ITERATOR = new C09442();

    /* renamed from: com.google.common.collect.Iterators$1 */
    static class C09431 extends UnmodifiableListIterator<Object> {
    ...
    static class C09442 implements Iterator<Object> {
        public boolean hasNext() {
            return false;
        }
    ...
    public static String toString(Iterator<?> it) {
        ...
        it = joiner.appendTo(stringBuilder, (Iterator) it);
        it.append(']');
        return it.toString();
    }
        ...
        return new UnmodifiableIterator<List<T>>() {
            ...
            public List<T> next() {
                if (hasNext()) {
                    ...
                    return i == i ? unmodifiableList : unmodifiableList.subList(0, i);
                } else {
                    throw new NoSuchElementException();
                }
            }
    ...
    public static <T> boolean any(Iterator<T> it, Predicate<? super T> predicate) {
        return indexOf(it, predicate) != -1 ? true : null;
    }
    ...
    public static <T> Optional<T> tryFind(Iterator<T> it, Predicate<? super T> predicate) {
        it = filter((Iterator) it, (Predicate) predicate);
        return it.hasNext() != null ? Optional.of(it.next()) : Optional.absent();
    }
