...
import android.support.v7.recyclerview.C0268R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C03273();
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C03311();
        ...
        private final Callback mVerticalBoundCheckCallback = new C03322();
        private int mWidth;
        ...
        class C03311 implements Callback {
            C03311() {
            }
        ...
        class C03322 implements Callback {
            C03322() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0268R.styleable.RecyclerView, i, i2);
            properties.orientation = context.getInt(C0268R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = context.getInt(C0268R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = context.getBoolean(C0268R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = context.getBoolean(C0268R.styleable.RecyclerView_stackFromEnd, false);
            context.recycle();
            return properties;
        }
    ...
    static class C03273 implements Interpolator {
    ...
    class C03284 implements ProcessCallback {
        C03284() {
        }
    ...
    class C03295 implements Callback {
        C03295() {
        }
    ...
    class C03306 implements Callback {
        C03306() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C03331();
        Parcelable mLayoutState;

        /* renamed from: android.support.v7.widget.RecyclerView$SavedState$1 */
        static class C03331 implements ClassLoaderCreator<SavedState> {
            C03331() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C03251();
        ...
        this.mItemAnimatorRunner = new C03262();
        this.mViewInfoProcessCallback = new C03284();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0268R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0268R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0268R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0268R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0268R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0268R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0268R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0268R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            obtainStyledAttributes.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03295());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03306());
    }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (!(stateListDrawable == null || drawable == null || stateListDrawable2 == null)) {
            if (drawable2 != null) {
                ...
                FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0268R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0268R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0268R.dimen.fastscroll_margin));
                return;
            }
        }
