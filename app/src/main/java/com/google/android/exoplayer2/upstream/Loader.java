...
*/
        ...
        L_0x0010:
            ...
            com.google.android.exoplayer2.util.TraceUtil.beginSection(r2);	 Catch:{ IOException -> 0x009c, InterruptedException -> 0x008b, Exception -> 0x0072, OutOfMemoryError -> 0x0059, Error -> 0x0044 }
            r2 = r4.loadable;	 Catch:{ all -> 0x0037 }
            r2.load();	 Catch:{ all -> 0x0037 }
            com.google.android.exoplayer2.util.TraceUtil.endSection();	 Catch:{ IOException -> 0x009c, InterruptedException -> 0x008b, Exception -> 0x0072, OutOfMemoryError -> 0x0059, Error -> 0x0044 }
