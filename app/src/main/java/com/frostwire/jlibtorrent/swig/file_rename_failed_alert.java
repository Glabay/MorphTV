...
public class file_rename_failed_alert extends torrent_alert {
    ...
    protected file_rename_failed_alert(long j, boolean z) {
        super(libtorrent_jni.file_rename_failed_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(file_rename_failed_alert file_rename_failed_alert) {
        return file_rename_failed_alert == null ? 0 : file_rename_failed_alert.swigCPtr;
    }
