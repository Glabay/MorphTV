...
public final class SpliceScheduleCommand extends SpliceCommand {
    public static final Creator<SpliceScheduleCommand> CREATOR = new C07161();
    public final List<Event> events;

    /* renamed from: com.google.android.exoplayer2.metadata.scte35.SpliceScheduleCommand$1 */
    static class C07161 implements Creator<SpliceScheduleCommand> {
        C07161() {
        }
    ...
    public static final class Event {
        ...
        private static Event parseFromSection(ParsableByteArray parsableByteArray) {
            ...
            if (z4) {
                ...
                long readUnsignedInt3 = z6 ? parsableByteArray.readUnsignedInt() : C0649C.TIME_UNSET;
                if (z6) {
