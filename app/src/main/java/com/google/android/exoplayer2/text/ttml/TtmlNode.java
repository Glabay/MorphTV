...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String str) {
        return new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(str), C0649C.TIME_UNSET, C0649C.TIME_UNSET, null, null, "");
    }
    ...
    public boolean isActive(long j) {
        return (!(this.startTimeUs == C0649C.TIME_UNSET && this.endTimeUs == C0649C.TIME_UNSET) && ((this.startTimeUs > j || this.endTimeUs != C0649C.TIME_UNSET) && ((this.startTimeUs != C0649C.TIME_UNSET || j >= this.endTimeUs) && (this.startTimeUs > j || j >= this.endTimeUs)))) ? 0 : 1;
    }
    ...
    private void getEventTimes(TreeSet<Long> treeSet, boolean z) {
        ...
        if (z || equals) {
            if (this.startTimeUs != C0649C.TIME_UNSET) {
                treeSet.add(Long.valueOf(this.startTimeUs));
            }
            if (this.endTimeUs != C0649C.TIME_UNSET) {
