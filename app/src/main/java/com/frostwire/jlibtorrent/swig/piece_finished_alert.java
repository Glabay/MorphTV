...
public class piece_finished_alert extends torrent_alert {
    ...
    protected piece_finished_alert(long j, boolean z) {
        super(libtorrent_jni.piece_finished_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(piece_finished_alert piece_finished_alert) {
        return piece_finished_alert == null ? 0 : piece_finished_alert.swigCPtr;
    }
