...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00781();
...
*/
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C00792();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C00781 implements ThreadFactory {
    ...
    class C00792 extends WorkerRunnable<Params, Result> {
        C00792() {
        }
