...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00752();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00741();
    ...
    class C00752 implements OnItemClickListener {
        C00752() {
        }
