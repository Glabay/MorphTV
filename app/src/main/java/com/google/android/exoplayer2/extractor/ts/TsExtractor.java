...
public final class TsExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new C06971();
    ...
    static class C06971 implements ExtractorsFactory {
        C06971() {
        }
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException, InterruptedException {
        ...
        Object obj = (bytesLeft & 32) != 0 ? 1 : null;
        TsPayloadReader tsPayloadReader = ((bytesLeft & 16) != 0 ? 1 : null) != null ? (TsPayloadReader) this.tsPayloadReaders.get(i2) : null;
        if (tsPayloadReader == null) {
            this.tsPacketBuffer.setPosition(positionHolder);
            return 0;
        }
