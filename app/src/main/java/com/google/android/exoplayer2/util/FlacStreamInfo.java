...
public final class FlacStreamInfo {
    ...
    public FlacStreamInfo(byte[] bArr, int i) {
        ...
        this.totalSamples = ((((long) parsableBitArray.readBits(4)) & 15) << 32) | (((long) parsableBitArray.readBits(32)) & InternalZipConstants.ZIP_64_LIMIT);
    }
    ...
    public long durationUs() {
        return (this.totalSamples * C0649C.MICROS_PER_SECOND) / ((long) this.sampleRate);
    }
}
