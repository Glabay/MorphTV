...
public class DragStartHelper {
    ...
    private final OnLongClickListener mLongClickListener = new C00401();
    private final OnTouchListener mTouchListener = new C00412();
    private final View mView;

    /* renamed from: android.support.v13.view.DragStartHelper$1 */
    class C00401 implements OnLongClickListener {
        C00401() {
        }
    ...
    class C00412 implements OnTouchListener {
        C00412() {
        }
