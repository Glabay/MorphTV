...
public class Rarbg123Provider extends BaseProvider {
    String base_link;
    String[] domains;

    public Rarbg123Provider(Scraper scraper) {
        super(scraper, "123RARBG.COM", true);
        this.domains = new String[]{"123rarbg.com"};
        this.base_link = "http://123rarbg.com";
...
*/
    ...
    L_0x0119:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: io.github.morpheustv.scrapers.providers.Rarbg123Provider.getSources(io.github.morpheustv.scrapers.model.ProviderSearchResult, java.util.concurrent.CopyOnWriteArrayList):void");
    }
}
