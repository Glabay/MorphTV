...
public class SsManifest {
    ...
    public static class StreamElement {
        ...
        public StreamElement(String str, String str2, int i, String str3, long j, String str4, int i2, int i3, int i4, int i5, String str5, Format[] formatArr, List<Long> list, long j2) {
            long j3 = j;
            this(str, str2, i, str3, j3, str4, i2, i3, i4, i5, str5, formatArr, list, Util.scaleLargeTimestamps(list, C0649C.MICROS_PER_SECOND, j3), Util.scaleLargeTimestamp(j2, C0649C.MICROS_PER_SECOND, j3));
        }
    ...
    public SsManifest(int i, int i2, long j, long j2, long j3, int i3, boolean z, ProtectionElement protectionElement, StreamElement[] streamElementArr) {
        ...
        long j4 = C0649C.TIME_UNSET;
        long scaleLargeTimestamp = i4 == 0 ? C0649C.TIME_UNSET : Util.scaleLargeTimestamp(j2, C0649C.MICROS_PER_SECOND, j);
        if (j3 != 0) {
            j4 = Util.scaleLargeTimestamp(j3, C0649C.MICROS_PER_SECOND, j);
        }
