...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02931 extends DataSetObserver {
        C02931() {
        }
    ...
    class C02953 extends AccessibilityDelegate {
        C02953() {
        }
    ...
    class C02975 extends DataSetObserver {
        C02975() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            switch (getItemViewType(i)) {
                case 0:
                    if (view == null || view.getId() != C0249R.id.list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0249R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    }
                    viewGroup = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                    ((ImageView) view.findViewById(C0249R.id.icon)).setImageDrawable(resolveInfo.loadIcon(viewGroup));
                    ((TextView) view.findViewById(C0249R.id.title)).setText(resolveInfo.loadLabel(viewGroup));
                ...
                case 1:
                    if (view == null || view.getId() != 1) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0249R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                        view.setId(1);
                        ((TextView) view.findViewById(C0249R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0249R.string.abc_activity_chooser_view_see_all));
                    }
                    return view;
                default:
                    throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetObserver = new C02931();
        this.mOnGlobalLayoutListener = new C02942();
        this.mInitialActivityCount = 4;
        attributeSet = context.obtainStyledAttributes(attributeSet, C0249R.styleable.ActivityChooserView, i, 0);
        this.mInitialActivityCount = attributeSet.getInt(C0249R.styleable.ActivityChooserView_initialActivityCount, 4);
        i = attributeSet.getDrawable(C0249R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        ...
        FrameLayout frameLayout = (FrameLayout) findViewById(C0249R.id.expand_activities_button);
        frameLayout.setOnClickListener(this.mCallbacks);
        frameLayout.setAccessibilityDelegate(new C02953());
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C0249R.id.image);
        this.mExpandActivityOverflowButtonImage.setImageDrawable(i);
        this.mAdapter = new ActivityChooserViewAdapter();
        this.mAdapter.registerDataSetObserver(new C02975());
        context = context.getResources();
        this.mListPopupMaxWidth = Math.max(context.getDisplayMetrics().widthPixels / 2, context.getDimensionPixelSize(C0249R.dimen.abc_config_prefDialogWidth));
    }
        ...
        if (!i.isShowing()) {
            if (!this.mIsSelectingDefaultActivity) {
                if (z) {
                    ...
                    i.getListView().setContentDescription(getContext().getString(C0249R.string.abc_activitychooserview_choose_application));
