...
public class torrent_error_alert extends torrent_alert {
    ...
    protected torrent_error_alert(long j, boolean z) {
        super(libtorrent_jni.torrent_error_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(torrent_error_alert torrent_error_alert) {
        return torrent_error_alert == null ? 0 : torrent_error_alert.swigCPtr;
    }
    ...
    public error_code getError() {
        long torrent_error_alert_error_get = libtorrent_jni.torrent_error_alert_error_get(this.swigCPtr, this);
        if (torrent_error_alert_error_get == 0) {
            return null;
        }
        return new error_code(torrent_error_alert_error_get, false);
    }
