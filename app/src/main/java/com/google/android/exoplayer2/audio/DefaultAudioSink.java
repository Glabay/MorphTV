...
public final class DefaultAudioSink implements AudioSink {
    ...
    private static class AudioTrackUtil {
        ...
        public void reconfigure(AudioTrack audioTrack, boolean z) {
            ...
            this.stopTimestampUs = C0649C.TIME_UNSET;
            this.forceResetWorkaroundTimeMs = C0649C.TIME_UNSET;
        ...
        public void pause() {
            if (this.stopTimestampUs == C0649C.TIME_UNSET) {
                this.audioTrack.pause();
            }
        }

        public boolean needsReset(long j) {
            return (this.forceResetWorkaroundTimeMs == C0649C.TIME_UNSET || j <= 0 || SystemClock.elapsedRealtime() - this.forceResetWorkaroundTimeMs < FORCE_RESET_WORKAROUND_TIMEOUT_MS) ? 0 : 1;
        }

        public long getPlaybackHeadPosition() {
            if (this.stopTimestampUs != C0649C.TIME_UNSET) {
                return Math.min(this.endPlaybackHeadPosition, this.stopPlaybackHeadPosition + ((((SystemClock.elapsedRealtime() * 1000) - this.stopTimestampUs) * ((long) this.sampleRate)) / C0649C.MICROS_PER_SECOND));
            }
            ...
            long j;
            long playbackHeadPosition = ((long) this.audioTrack.getPlaybackHeadPosition()) & InternalZipConstants.ZIP_64_LIMIT;
            ...
            if (Util.SDK_INT <= 28) {
                if (j == 0 && this.lastRawPlaybackHeadPosition > 0 && playState == 3) {
                    if (this.forceResetWorkaroundTimeMs == C0649C.TIME_UNSET) {
        ...
        public long getPositionUs() {
            return (getPlaybackHeadPosition() * C0649C.MICROS_PER_SECOND) / ((long) this.sampleRate);
        }
    ...
    public DefaultAudioSink(@android.support.annotation.Nullable com.google.android.exoplayer2.audio.AudioCapabilities r4, com.google.android.exoplayer2.audio.AudioProcessor[] r5, boolean r6) {
...
*/
        ...
        r3.enableConvertHighResIntPcmToFloat = r6;
    ...
    L_0x0016:
        r4 = android.media.AudioTrack.class;	 Catch:{ NoSuchMethodException -> 0x0023 }
        ...
        r4 = r4.getMethod(r1, r2);	 Catch:{ NoSuchMethodException -> 0x0023 }
        r3.getLatencyMethod = r4;	 Catch:{ NoSuchMethodException -> 0x0023 }
    L_0x0023:
        r4 = com.google.android.exoplayer2.util.Util.SDK_INT;
        r1 = 19;
        if (r4 < r1) goto L_0x0031;
    L_0x0029:
        r4 = new com.google.android.exoplayer2.audio.DefaultAudioSink$AudioTrackUtilV19;
        r4.<init>();
        r3.audioTrackUtil = r4;
        goto L_0x0038;
    L_0x0031:
        r4 = new com.google.android.exoplayer2.audio.DefaultAudioSink$AudioTrackUtil;
        r4.<init>();
        r3.audioTrackUtil = r4;
    L_0x0038:
        ...
        r4 = new com.google.android.exoplayer2.audio.TrimmingAudioProcessor;
        r4.<init>();
        r3.trimmingAudioProcessor = r4;
        ...
        r3.toIntPcmAvailableAudioProcessors = r4;
        r4 = r3.toIntPcmAvailableAudioProcessors;
        r0 = new com.google.android.exoplayer2.audio.ResamplingAudioProcessor;
        r0.<init>();
        r1 = 0;
        r4[r1] = r0;
        r4 = r3.toIntPcmAvailableAudioProcessors;
        r0 = r3.channelMappingAudioProcessor;
        r4[r6] = r0;
        r4 = r3.toIntPcmAvailableAudioProcessors;
        r0 = 2;
        r2 = r3.trimmingAudioProcessor;
        r4[r0] = r2;
        r4 = r3.toIntPcmAvailableAudioProcessors;
        r0 = r5.length;
        r2 = 3;
        java.lang.System.arraycopy(r5, r1, r4, r2, r0);
        r4 = r3.toIntPcmAvailableAudioProcessors;
        r5 = r5.length;
        r5 = r5 + r2;
        r0 = r3.sonicAudioProcessor;
        r4[r5] = r0;
        r4 = new com.google.android.exoplayer2.audio.AudioProcessor[r6];
        r5 = new com.google.android.exoplayer2.audio.FloatResamplingAudioProcessor;
        r5.<init>();
        r4[r1] = r5;
        r3.toFloatPcmAvailableAudioProcessors = r4;
        r4 = 10;
        r4 = new long[r4];
        r3.playheadOffsets = r4;
        r4 = 1065353216; // 0x3f800000 float:1.0 double:5.263544247E-315;
        r3.volume = r4;
        r3.startMediaTimeState = r1;
        r4 = com.google.android.exoplayer2.audio.AudioAttributes.DEFAULT;
        r3.audioAttributes = r4;
        r3.audioSessionId = r1;
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.audio.DefaultAudioSink.<init>(com.google.android.exoplayer2.audio.AudioCapabilities, com.google.android.exoplayer2.audio.AudioProcessor[], boolean):void");
    }
    ...
    public void configure(int i, int i2, int i3, int i4, @Nullable int[] iArr, int i5, int i6) throws ConfigurationException {
        ...
        switch (i2) {
            ...
            case 7:
                ...
                break;
            case 8:
                i7 = C0649C.CHANNEL_OUT_7POINT1_SURROUND;
                break;
            default:
        ...
        if (Util.SDK_INT <= 23 && "foster".equals(Util.DEVICE) && "NVIDIA".equals(Util.MANUFACTURER)) {
            if (!(i2 == 3 || i2 == 5)) {
                if (i2 == 7) {
                    i5 = C0649C.CHANNEL_OUT_7POINT1_SURROUND;
                }
            }
            ...
            if (i3 == 0 || isInitialized() == 0 || this.outputEncoding != i || this.sampleRate != i6 || this.channelConfig != iArr) {
                ...
                this.bufferSizeUs = this.isInputPcm == 0 ? framesToDurationUs((long) (this.bufferSize / this.outputPcmFrameSize)) : C0649C.TIME_UNSET;
            }
            return;
        }
        i5 = i7;
        ...
        if (this.inputBuffer != null) {
            if (byteBuffer2 != r0.inputBuffer) {
                ...
                if (!(!z || r0.hasData || r0.audioTrack.getPlayState() == 1 || r0.listener == null)) {
                    r0.listener.onUnderrun(r0.bufferSize, C0649C.usToMs(r0.bufferSizeUs), SystemClock.elapsedRealtime() - r0.lastFeedElapsedRealtimeMs);
                }
...
*/
    ...
    L_0x00e0:
        r2 = new com.google.android.exoplayer2.audio.DefaultAudioSink$InvalidAudioTrackTimestampException;
        r2.<init>(r1);
        throw r2;
    L_0x00e6:
        r2 = "AudioTrack";
    ...
    L_0x0156:
        r1 = 0;
        r2 = r0.getLatencyMethod;	 Catch:{ Exception -> 0x01a1 }
        r3 = r0.audioTrack;	 Catch:{ Exception -> 0x01a1 }
        r4 = r1;	 Catch:{ Exception -> 0x01a1 }
        r4 = (java.lang.Object[]) r4;	 Catch:{ Exception -> 0x01a1 }
        r2 = r2.invoke(r3, r4);	 Catch:{ Exception -> 0x01a1 }
        r2 = (java.lang.Integer) r2;	 Catch:{ Exception -> 0x01a1 }
        r2 = r2.intValue();	 Catch:{ Exception -> 0x01a1 }
        r2 = (long) r2;	 Catch:{ Exception -> 0x01a1 }
        r7 = 1000; // 0x3e8 float:1.401E-42 double:4.94E-321;	 Catch:{ Exception -> 0x01a1 }
        r2 = r2 * r7;	 Catch:{ Exception -> 0x01a1 }
        r7 = r0.bufferSizeUs;	 Catch:{ Exception -> 0x01a1 }
        r4 = 0;	 Catch:{ Exception -> 0x01a1 }
        r12 = r2 - r7;	 Catch:{ Exception -> 0x01a1 }
        r0.latencyUs = r12;	 Catch:{ Exception -> 0x01a1 }
        r2 = r0.latencyUs;	 Catch:{ Exception -> 0x01a1 }
        r7 = 0;	 Catch:{ Exception -> 0x01a1 }
        r2 = java.lang.Math.max(r2, r7);	 Catch:{ Exception -> 0x01a1 }
        r0.latencyUs = r2;	 Catch:{ Exception -> 0x01a1 }
        r2 = r0.latencyUs;	 Catch:{ Exception -> 0x01a1 }
        r4 = (r2 > r10 ? 1 : (r2 == r10 ? 0 : -1));	 Catch:{ Exception -> 0x01a1 }
        if (r4 <= 0) goto L_0x01a3;	 Catch:{ Exception -> 0x01a1 }
    L_0x0184:
        r2 = "AudioTrack";	 Catch:{ Exception -> 0x01a1 }
        r3 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x01a1 }
        r3.<init>();	 Catch:{ Exception -> 0x01a1 }
        r4 = "Ignoring impossibly large audio latency: ";	 Catch:{ Exception -> 0x01a1 }
        r3.append(r4);	 Catch:{ Exception -> 0x01a1 }
        r7 = r0.latencyUs;	 Catch:{ Exception -> 0x01a1 }
        r3.append(r7);	 Catch:{ Exception -> 0x01a1 }
        r3 = r3.toString();	 Catch:{ Exception -> 0x01a1 }
        android.util.Log.w(r2, r3);	 Catch:{ Exception -> 0x01a1 }
        r2 = 0;	 Catch:{ Exception -> 0x01a1 }
        r0.latencyUs = r2;	 Catch:{ Exception -> 0x01a1 }
        goto L_0x01a3;
    L_0x01a1:
    ...
    L_0x01a5:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.audio.DefaultAudioSink.maybeSampleSyncParams():void");
    }
    ...
    private long inputFramesToDurationUs(long j) {
        return (j * C0649C.MICROS_PER_SECOND) / ((long) this.inputSampleRate);
    }

    private long framesToDurationUs(long j) {
        return (j * C0649C.MICROS_PER_SECOND) / ((long) this.sampleRate);
    }

    private long durationUsToFrames(long j) {
        return (j * ((long) this.sampleRate)) / C0649C.MICROS_PER_SECOND;
    }
