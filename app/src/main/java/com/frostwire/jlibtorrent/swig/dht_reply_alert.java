...
public class dht_reply_alert extends tracker_alert {
    ...
    protected dht_reply_alert(long j, boolean z) {
        super(libtorrent_jni.dht_reply_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(dht_reply_alert dht_reply_alert) {
        return dht_reply_alert == null ? 0 : dht_reply_alert.swigCPtr;
    }
