...
*/
    ...
    public static class MediaItem implements Parcelable {
        public static final Creator<MediaItem> CREATOR = new C01051();
        ...
        static class C01051 implements Creator<MediaItem> {
            C01051() {
            }
