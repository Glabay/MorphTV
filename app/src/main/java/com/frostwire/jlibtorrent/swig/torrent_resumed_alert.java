...
public class torrent_resumed_alert extends torrent_alert {
    ...
    protected torrent_resumed_alert(long j, boolean z) {
        super(libtorrent_jni.torrent_resumed_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(torrent_resumed_alert torrent_resumed_alert) {
        return torrent_resumed_alert == null ? 0 : torrent_resumed_alert.swigCPtr;
    }
