...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02461();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02472();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02483();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$1 */
    class C02461 extends ViewPropertyAnimatorListenerAdapter {
        C02461() {
        }
    ...
    class C02472 extends ViewPropertyAnimatorListenerAdapter {
        C02472() {
        }
    ...
    class C02483 implements ViewPropertyAnimatorUpdateListener {
        C02483() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0249R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0249R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0249R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0249R.id.action_bar_container);
            ...
            if (this.mContainerView != null) {
                ...
                if (!actionBarPolicy.enableHomeButtonByDefault()) {
                    if (view == null) {
                        ...
                        view = this.mContext.obtainStyledAttributes(null, C0249R.styleable.ActionBar, C0249R.attr.actionBarStyle, 0);
                        if (view.getBoolean(C0249R.styleable.ActionBar_hideOnContentScroll, false)) {
                            setHideOnContentScrollEnabled(true);
                        }
                        dimensionPixelSize = view.getDimensionPixelSize(C0249R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0249R.attr.actionBarWidgetTheme, typedValue, true);
