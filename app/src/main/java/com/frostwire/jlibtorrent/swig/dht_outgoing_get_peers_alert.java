...
public class dht_outgoing_get_peers_alert extends alert {
    ...
    protected dht_outgoing_get_peers_alert(long j, boolean z) {
        super(libtorrent_jni.dht_outgoing_get_peers_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(dht_outgoing_get_peers_alert dht_outgoing_get_peers_alert) {
        return dht_outgoing_get_peers_alert == null ? 0 : dht_outgoing_get_peers_alert.swigCPtr;
    }
    ...
    public void setInfo_hash(sha1_hash sha1_hash) {
        libtorrent_jni.dht_outgoing_get_peers_alert_info_hash_set(this.swigCPtr, this, sha1_hash.getCPtr(sha1_hash), sha1_hash);
    }
    ...
    public void setObfuscated_info_hash(sha1_hash sha1_hash) {
        libtorrent_jni.dht_outgoing_get_peers_alert_obfuscated_info_hash_set(this.swigCPtr, this, sha1_hash.getCPtr(sha1_hash), sha1_hash);
    }
