...
public class ScreenCouchIsProvider extends BaseProvider {
    String base_link = "https://screencouch.is";
    String[] domains = new String[]{"screencouch.is"};
...
*/
    ...
    L_0x0008:
        ...
        goto L_0x0107;	 Catch:{ Exception -> 0x0008 }
    L_0x000b:
    ...
    L_0x005d:
        r2 = "li[itemprop=episode]";	 Catch:{ Exception -> 0x0008 }
    ...
    L_0x006d:
        ...
        r4 = "span[itemprop=name]";	 Catch:{ Exception -> 0x0008 }
        ...
        if (r2 == 0) goto L_0x0067;	 Catch:{ Exception -> 0x0008 }
    L_0x00ab:
    ...
    L_0x00c8:
        r1 = "ul.stream-list";	 Catch:{ Exception -> 0x0008 }
        r0 = r0.select(r1);	 Catch:{ Exception -> 0x0008 }
    ...
    L_0x00de:
        r1 = r0.next();	 Catch:{ Exception -> 0x0008 }
        r1 = (org.jsoup.nodes.Element) r1;	 Catch:{ Exception -> 0x0008 }
        r2 = "href";	 Catch:{ Exception -> 0x00d8 }
        r1 = r1.attr(r2);	 Catch:{ Exception -> 0x00d8 }
        r2 = r11.getPageUrl();	 Catch:{ Exception -> 0x00d8 }
        r4 = r10.grablink(r1, r2);	 Catch:{ Exception -> 0x00d8 }
        r5 = r11.getPageUrl();	 Catch:{ Exception -> 0x00d8 }
        r6 = 0;	 Catch:{ Exception -> 0x00d8 }
        r8 = r11.getTitle();	 Catch:{ Exception -> 0x00d8 }
        r3 = r10;	 Catch:{ Exception -> 0x00d8 }
        r7 = r12;	 Catch:{ Exception -> 0x00d8 }
        r3.processLink(r4, r5, r6, r7, r8);	 Catch:{ Exception -> 0x00d8 }
        r1 = r10.hasMaxSources(r12);	 Catch:{ Exception -> 0x00d8 }
    ...
    L_0x010a:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: io.github.morpheustv.scrapers.providers.ScreenCouchIsProvider.getSources(io.github.morpheustv.scrapers.model.ProviderSearchResult, java.util.concurrent.CopyOnWriteArrayList):void");
    }
}
