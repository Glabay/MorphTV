...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01811();
    ...
    private static final Interpolator sInterpolator = new C01822();
    ...
    private final Runnable mEndScrollRunnable = new C01833();
