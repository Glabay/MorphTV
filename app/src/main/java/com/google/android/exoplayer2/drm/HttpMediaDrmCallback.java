...
public final class HttpMediaDrmCallback implements MediaDrmCallback {
    ...
    public byte[] executeKeyRequest(UUID uuid, KeyRequest keyRequest) throws Exception {
        ...
        Object obj = C0649C.PLAYREADY_UUID.equals(uuid) ? "text/xml" : C0649C.CLEARKEY_UUID.equals(uuid) ? TraktV2.CONTENT_TYPE_JSON : "application/octet-stream";
        hashMap.put("Content-Type", obj);
        if (C0649C.PLAYREADY_UUID.equals(uuid) != null) {
