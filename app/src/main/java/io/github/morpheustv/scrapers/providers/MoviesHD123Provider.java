...
public class MoviesHD123Provider extends BaseProvider {
    String base_link;
    String[] domains;

    public MoviesHD123Provider(Scraper scraper) {
        super(scraper, "123MOVIESHD.SC", true);
        this.domains = new String[]{"123movieshd.sc"};
        this.base_link = "https://123movieshd.sc";
        ...
        try {
            for (String str3 : list) {
                try {
                    ...
                    stringBuilder2.append("/browse-word/");
            ...
            try {
                for (String str2 : list) {
                    try {
                        ...
                        URL url = new URL(this.base_link);
                        StringBuilder stringBuilder = new StringBuilder();
                        stringBuilder.append("/browse-word/");
                        StringBuilder stringBuilder2 = new StringBuilder();
