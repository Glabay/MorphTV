...
public final class SpliceInsertCommand extends SpliceCommand {
    public static final Creator<SpliceInsertCommand> CREATOR = new C07141();
    ...
    static class C07141 implements Creator<SpliceInsertCommand> {
        C07141() {
        }
    ...
    static SpliceInsertCommand parseFromSection(ParsableByteArray parsableByteArray, long j, TimestampAdjuster timestampAdjuster) {
        ...
        if (z5) {
            ...
            j3 = (!z8 || z9) ? C0649C.TIME_UNSET : TimeSignalCommand.parseSpliceTime(parsableByteArray, j);
            if (z8) {
                list2 = emptyList;
            } else {
            ...
            if (obj != null) {
                ...
                z6 = false;
                readUnsignedInt2 = C0649C.TIME_UNSET;
            }
