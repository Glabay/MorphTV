...
public class peer_error_alert extends peer_alert {
    ...
    protected peer_error_alert(long j, boolean z) {
        super(libtorrent_jni.peer_error_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(peer_error_alert peer_error_alert) {
        return peer_error_alert == null ? 0 : peer_error_alert.swigCPtr;
    }
    ...
    public void setOp(operation_t operation_t) {
        libtorrent_jni.peer_error_alert_op_set(this.swigCPtr, this, operation_t.swigValue());
    }
