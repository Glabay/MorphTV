...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new C02711();

    /* renamed from: android.support.v7.util.DiffUtil$1 */
    static class C02711 implements Comparator<Snake> {
        C02711() {
        }
            ...
            if (this.mDetectMoves) {
                for (i2--; i2 >= 0; i2--) {
                    ...
                    if (i5 == 0) {
                        ...
                        listUpdateCallback.append(StringUtils.SPACE);
