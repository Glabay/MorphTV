...
public class FrameMetricsAggregator {
    ...
    private static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        OnFrameMetricsAvailableListener mListener = new C00731();
        ...
        class C00731 implements OnFrameMetricsAvailableListener {
            C00731() {
            }
        ...
        void addDurationItem(SparseIntArray sparseIntArray, long j) {
            if (sparseIntArray != null) {
                int i = (int) ((j + 500000) / C0649C.MICROS_PER_SECOND);
                if (j >= 0) {
