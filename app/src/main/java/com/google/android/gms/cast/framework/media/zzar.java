...
*/
        ...
        r6 = r6.lock;
        monitor-enter(r6);
        r0 = r5.zzns;	 Catch:{ IllegalArgumentException -> 0x0019, IllegalArgumentException -> 0x0019, IllegalArgumentException -> 0x0019 }
        r0 = r0.zzeu;	 Catch:{ IllegalArgumentException -> 0x0019, IllegalArgumentException -> 0x0019, IllegalArgumentException -> 0x0019 }
        r1 = r5.zzgc;	 Catch:{ IllegalArgumentException -> 0x0019, IllegalArgumentException -> 0x0019, IllegalArgumentException -> 0x0019 }
        r2 = r5.zzfw;	 Catch:{ IllegalArgumentException -> 0x0019, IllegalArgumentException -> 0x0019, IllegalArgumentException -> 0x0019 }
        r4 = r5.zzfi;	 Catch:{ IllegalArgumentException -> 0x0019, IllegalArgumentException -> 0x0019, IllegalArgumentException -> 0x0019 }
