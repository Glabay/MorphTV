...
public class dht_put_alert extends alert {
    ...
    protected dht_put_alert(long j, boolean z) {
        super(libtorrent_jni.dht_put_alert_SWIGUpcast(j), z);
        this.swigCPtr = j;
    }

    protected static long getCPtr(dht_put_alert dht_put_alert) {
        return dht_put_alert == null ? 0 : dht_put_alert.swigCPtr;
    }
    ...
    public void setTarget(sha1_hash sha1_hash) {
        libtorrent_jni.dht_put_alert_target_set(this.swigCPtr, this, sha1_hash.getCPtr(sha1_hash), sha1_hash);
    }
