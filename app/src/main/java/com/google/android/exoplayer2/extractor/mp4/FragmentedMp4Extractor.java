...
public final class FragmentedMp4Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new C06881();
    public static final int FLAG_ENABLE_EMSG_TRACK = 4;
    private static final int FLAG_SIDELOADED = 8;
    public static final int FLAG_WORKAROUND_EVERY_VIDEO_FRAME_IS_SYNC_FRAME = 1;
    public static final int FLAG_WORKAROUND_IGNORE_EDIT_LISTS = 16;
    public static final int FLAG_WORKAROUND_IGNORE_TFDT_BOX = 2;
    private static final byte[] PIFF_SAMPLE_ENCRYPTION_BOX_EXTENDED_TYPE = new byte[]{(byte) -94, (byte) 57, (byte) 79, (byte) 82, (byte) 90, (byte) -101, (byte) 79, Ascii.DC4, (byte) -94, (byte) 68, (byte) 108, (byte) 66, (byte) 124, (byte) 100, (byte) -115, (byte) -12};
    ...
    static class C06881 implements ExtractorsFactory {
        C06881() {
        }
    ...
    public FragmentedMp4Extractor(int i, TimestampAdjuster timestampAdjuster, Track track, DrmInitData drmInitData, List<Format> list, @Nullable TrackOutput trackOutput) {
        ...
        this.segmentIndexEarliestPresentationTimeUs = C0649C.TIME_UNSET;
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        if (this.emsgTrackOutputs != null) {
            if (this.emsgTrackOutputs.length != 0) {
                ...
                parsableByteArray.readNullTerminatedString();
                long scaleLargeTimestamp = Util.scaleLargeTimestamp(parsableByteArray.readUnsignedInt(), C0649C.MICROS_PER_SECOND, parsableByteArray.readUnsignedInt());
                for (TrackOutput trackOutput : this.emsgTrackOutputs) {
                    parsableByteArray.setPosition(12);
                    trackOutput.sampleData(parsableByteArray, bytesLeft);
                }
                if (this.segmentIndexEarliestPresentationTimeUs != C0649C.TIME_UNSET) {
    ...
    private static int parseTrun(TrackBundle trackBundle, int i, long j, int i2, ParsableByteArray parsableByteArray, int i3) {
        ...
        Object obj6 = (parseFullAtomFlags & 2048) != 0 ? 1 : null;
        long j3 = 0;
        ...
        int[] iArr4 = iArr2;
        Object obj7 = (track.type != 2 || (i2 & 1) == 0) ? null : 1;
        ...
        while (i6 < i4) {
            ...
            int i7;
            Object obj9;
            int readUnsignedIntToInt = obj3 != null ? parsableByteArray.readUnsignedIntToInt() : defaultSampleValues.duration;
            int readUnsignedIntToInt2 = obj4 != null ? parsableByteArray.readUnsignedIntToInt() : defaultSampleValues.size;
            if (i6 == 0 && obj2 != null) {
                obj8 = obj2;
                i7 = i5;
            } else if (obj5 != null) {
            ...
            if (obj6 != null) {
                obj9 = obj6;
                iArr[i6] = (int) ((((long) parsableByteArray.readInt()) * 1000) / j5);
            } else {
                obj9 = obj6;
                iArr[i6] = 0;
            }
            jArr3[i6] = Util.scaleLargeTimestamp(j2, 1000, j5) - j4;
            iArr4[i6] = readUnsignedIntToInt2;
    ...
    private static Pair<Long, ChunkIndex> parseSidx(ParsableByteArray parsableByteArray, long j) throws ParserException {
        ...
        readUnsignedInt2 = Util.scaleLargeTimestamp(j2, C0649C.MICROS_PER_SECOND, readUnsignedInt3);
        ...
        while (i < parseFullAtomVersion) {
            ...
            readUnsignedInt = Util.scaleLargeTimestamp(j5, C0649C.MICROS_PER_SECOND, readUnsignedInt3);
    ...
    private int appendSampleEncryptionData(TrackBundle trackBundle) {
        ...
        trackBundle.sampleData(parsableByteArray2, readUnsignedShort);
