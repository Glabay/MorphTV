...
public class AnimatorInflaterCompat {
    ...
    private static int inferValueTypeOfKeyframe(Resources resources, Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        ...
        attributeSet = null;
        theme = TypedArrayUtils.peekNamedValue(resources, xmlPullParser, XMLRPCClient.VALUE, 0);
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        TypedValue peekNamedValue = TypedArrayUtils.peekNamedValue(resources, xmlPullParser, XMLRPCClient.VALUE, 0);
        ...
        if (obj != null) {
            if (i != 3) {
                switch (i) {
                    case 0:
                        theme = Keyframe.ofFloat(theme, TypedArrayUtils.getNamedFloat(resources, xmlPullParser, XMLRPCClient.VALUE, 0, 0));
                        break;
                    case 1:
                        break;
                    default:
            ...
            theme = Keyframe.ofInt(theme, TypedArrayUtils.getNamedInt(resources, xmlPullParser, XMLRPCClient.VALUE, 0, 0));
        } else if (i == 0) {
