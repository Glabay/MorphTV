...
public final class OfflineLicenseHelper<T extends ExoMediaCrypto> {
    ...
    class C06811 implements EventListener {
        C06811() {
        }
    ...
    public static OfflineLicenseHelper<FrameworkMediaCrypto> newWidevineInstance(String str, boolean z, Factory factory, HashMap<String, String> hashMap) throws UnsupportedDrmException {
        return new OfflineLicenseHelper(C0649C.WIDEVINE_UUID, FrameworkMediaDrm.newInstance(C0649C.WIDEVINE_UUID), new HttpMediaDrmCallback(str, z, factory), hashMap);
    }
    ...
    public OfflineLicenseHelper(UUID uuid, ExoMediaDrm<T> exoMediaDrm, MediaDrmCallback mediaDrmCallback, HashMap<String, String> hashMap) {
        ...
        this.drmSessionManager = new DefaultDrmSessionManager(uuid2, exoMediaDrm2, mediaDrmCallback2, hashMap2, new Handler(this.handlerThread.getLooper()), new C06811());
    }
